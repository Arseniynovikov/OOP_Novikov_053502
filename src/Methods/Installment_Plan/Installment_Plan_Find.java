...
public class Installment_Plan_Find {
    public static Client Find(String str){
        ...
        try {
            String take = "SELECT * FROM " + Const.INSTALLMENT_PLAN_TABLE + " WHERE " + Const.INSTALLMENT_PLAN_NUMBER + "=? ";
            ...
            while (resSet.next()) {
                passport = resSet.getString(Const.INSTALLMENT_PLAN_CLIENTPASSPORT);
            }
